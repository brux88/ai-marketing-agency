...
const blogPosts: Record<string, { title: string; category: string; date: string; content: string }> = {
  "ai-content-marketing": {
    ...
    category: "WePostAI",
    date: "15 Apr 2026",
    content: `L'intelligenza artificiale sta trasformando radicalmente il modo in cui le aziende creano e distribuiscono contenuti di marketing. Gli agenti AI di WePostAI rappresentano l'evoluzione naturale di questo trend, offrendo la possibilita di generare contenuti originali e di qualita in modo completamente automatizzato.
...
Gli agenti AI di WePostAI analizzano il tono di voce del tuo brand, le tendenze del settore e le fonti di contenuto che configuri. Da queste informazioni, generano post originali che mantengono coerenza con la tua identita aziendale.
...
## Il flusso di lavoro con WePostAI
...
Le aziende che utilizzano WePostAI registrano un aumento medio del 300% nella frequenza di pubblicazione, mantenendo o migliorando la qualita percepita dei contenuti. Il tempo risparmiato puo essere reinvestito in strategie di alto livello.`,
  },
...
WePostAI monitora automaticamente le fonti che configuri — feed RSS, blog di settore, siti di news — e identifica gli argomenti piu rilevanti per il tuo pubblico.
...
Lo scheduler di WePostAI permette di configurare:
...
WePostAI supporta la pubblicazione diretta su:
...
WePostAI genera contenuti per le tue newsletter basandosi sulle fonti che configuri. Ogni edizione e unica e rilevante per il tuo settore.

### Frequenza costante
Con lo scheduler automatico, le tue newsletter partono sempre puntuali. Configura la frequenza — settimanale, bisettimanale o mensile — e WePostAI si occupa del resto.
...
## Configurare la newsletter in WePostAI
